var PointToCellIndex = function (x, y) {
    ...
    var offsetTableOY = this.tableOY * this.scaleY - ((this.scrollMode === 0) ? y : x);
    var offsetTableOX = this.tableOX * this.scaleX - ((this.scrollMode === 0) ? x : y);

    var table = this.table;
    var rowIdx = table.heightToRowIndex(-offsetTableOY / this.scaleY, 0);
    var colIdx = table.widthToColIndex(-offsetTableOX / this.scaleX);
